...
export REQUEST_TYPE="Delete"                              # Create/Update/Delete
export RESOURCEGROUP_LIKE="CreateDrupalUserLambdaFunction"  # Name of the Lambda function (part is sufficient), use "lambda" for all the log groups with Lambda functions
